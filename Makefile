...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/Ruk1ng001/Clash.Meta/constant.Version=$(VERSION)" \
		-X "github.com/Ruk1ng001/Clash.Meta/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
